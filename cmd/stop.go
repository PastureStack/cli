...
func StopCommand() cli.Command {
	return cli.Command{
		...
		Description: "\nStop resources by ID or name in the current $PLATFORM_ENVIRONMENT. Use `--env <envID>` or `--env <envName>` to select a different environment.\n\nExample:\n\t$ pasturestack stop 1s70\n\t$ pasturestack --env 1a5 stop stackName/serviceName \n",
		ArgsUsage:   "[ID NAME...]",
